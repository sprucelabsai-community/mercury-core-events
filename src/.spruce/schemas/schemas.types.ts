		...
		interface GetAgentEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			name: '',
			    fields: {
			            ...
			            'target': {
			                type: 'schema',
			                options: {schema: SpruceSchemas.Mercury.v2020_12_25.GetAgentEmitTargetSchema,}
			            },
			    }
		}
		...
		interface GetAgentResponsePayloadSchema extends SpruceSchema.Schema {
			...
			name: '',
			    fields: {
			            ...
			            'agent': {
			                type: 'schema',
			                options: {schema: SpruceSchemas.Spruce.v2020_07_22.AgentSchema,}
			            },
			    }
		}
			...
			name: '',
			    fields: {
			            ...
			            'agent': {
			                type: 'schema',
			                isRequired: true,
			                options: {schema: SpruceSchemas.Mercury.v2020_12_25.RegisterAgentSchema,}
			            },
			    }
		}
		...
		interface RegisterAgentEmitTargetAndPayloadSchema extends SpruceSchema.Schema {
			...
			name: '',
			    fields: {
			            ...
			            'target': {
			                type: 'schema',
			                options: {schema: SpruceSchemas.Mercury.v2020_12_25.RegisterAgentEmitTargetSchema,}
			            },
			            /** . */
			            'payload': {
			                type: 'schema',
			                isRequired: true,
			                options: {schema: SpruceSchemas.Mercury.v2020_12_25.RegisterAgentEmitPayloadSchema,}
			            },
			    }
		}
