...
const personWithMacSchema: SpruceSchemas.Mercury.v2020_12_25.PersonWithMacSchema  = {
	id: 'personWithMac',
	version: 'v2020_12_25',
	namespace: 'Mercury',
	name: '',
...
SchemaRegistry.getInstance().trackSchema(personWithMacSchema)

export default personWithMacSchema
