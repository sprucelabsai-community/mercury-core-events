...
const updateLocationEmitPayloadSchema: SpruceSchemas.Mercury.v2020_12_25.UpdateLocationEmitPayloadSchema =
    {
...
SchemaRegistry.getInstance().trackSchema(updateLocationEmitPayloadSchema)

export default updateLocationEmitPayloadSchema
