...
const publishedSkillSchema: SpruceSchemas.Mercury.v2020_12_25.PublishedSkillSchema  = {
	id: 'publishedSkill',
	version: 'v2020_12_25',
	namespace: 'Mercury',
	name: '',
...
SchemaRegistry.getInstance().trackSchema(publishedSkillSchema)

export default publishedSkillSchema
