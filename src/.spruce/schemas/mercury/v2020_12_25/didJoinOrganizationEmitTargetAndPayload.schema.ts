...
const didJoinOrganizationEmitTargetAndPayloadSchema: SpruceSchemas.Mercury.v2020_12_25.DidJoinOrganizationEmitTargetAndPayloadSchema =
    {
        ...
        fields: {
            ...
            target: {
                ...
                isRequired: true,
                options: {
                    schema: didJoinOrganizationEmitTargetSchema_v2020_12_25,
                },
            },
            /** . */
            payload: {
                ...
                isRequired: true,
                options: {
                    schema: didJoinOrganizationEmitPayloadSchema_v2020_12_25,
                },
            },
        },
    }
...
SchemaRegistry.getInstance().trackSchema(
    didJoinOrganizationEmitTargetAndPayloadSchema
)
