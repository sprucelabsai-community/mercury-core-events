...
const getResolvedPermissionsContractEmitTargetAndPayloadSchema: SpruceSchemas.Mercury.v2020_12_25.GetResolvedPermissionsContractEmitTargetAndPayloadSchema  = {
	...
	name: '',
	    fields: {
	            ...
	            'target': {
	                type: 'schema',
	                options: {schema: getResolvedPermissionsContractEmitTargetSchema_v2020_12_25,}
	            },
	            /** . */
	            'payload': {
	                type: 'schema',
	                isRequired: true,
	                options: {schema: getResolvedPermissionsContractEmitPayloadSchema_v2020_12_25,}
	            },
	    }
}

SchemaRegistry.getInstance().trackSchema(getResolvedPermissionsContractEmitTargetAndPayloadSchema)
